...
#define VCNL4040_ALS_IT_MASK       ((UINT8) ~((1 << 7) | (1 << 6)))
#define VCNL4040_ALS_IT_80MS       0
#define VCNL4040_ALS_IT_160MS      (1 << 7)
#define VCNL4040_ALS_IT_320MS      (1 << 6)
#define VCNL4040_ALS_IT_640MS      ((1 << 7) | (1 << 6))

#define VCNL4040_ALS_PERS_MASK     ((UINT8) ~((1 << 3) | (1 << 2)))
...
#define VCNL4040_PS_SMART_PERS_MASK    ((UINT8) ~((1 << 4)))
#define VCNL4040_PS_SMART_PERS_DISABLE 0
#define VCNL4040_PS_SMART_PERS_ENABLE  (1 << 4)

#define VCNL4040_PS_AF_MASK        ((UINT8) ~((1 << 3)))
#define VCNL4040_PS_AF_DISABLE     0
#define VCNL4040_PS_AF_ENABLE      (1 << 3)

#define VCNL4040_PS_TRIG_MASK      ((UINT8) ~((1 << 2)))
#define VCNL4040_PS_TRIG_TRIGGER   (1 << 2)

#define VCNL4040_WHITE_EN_MASK     ((UINT8) ~((1 << 7)))
#define VCNL4040_WHITE_ENABLE      0
#define VCNL4040_WHITE_DISABLE     (1 << 7)

#define VCNL4040_PS_MS_MASK        ((UINT8) ~((1 << 6)))
#define VCNL4040_PS_MS_DISABLE     0
#define VCNL4040_PS_MS_ENABLE      (1 << 6)

#define VCNL4040_LED_I_MASK        ((UINT8) ~((1 << 2) | (1 << 1) | (1 << 0)))
#define VCNL4040_LED_50MA          0
#define VCNL4040_LED_75MA          (1 << 0)
...
void bitMask(uint8_t commandAddress, uint8_t commandHeight, uint8_t mask, uint8_t thing)
{
  ...
  if (commandHeight == LOWER)
    registerContents = val & 0x0F;
  else
    registerContents = val >> 8;
